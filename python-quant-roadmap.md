...
1. *Multi-strategy backtester*: event-driven engine running momentum + pairs-trading with full cost model, walk-forward validation, and a tear-sheet report generator; or
2. *Fixed-income analytics library*: curve bootstrapper + bond pricer + duration/convexity + PCA study; or
3. *Risk engine*: portfolio VaR/ES via all three methods, GARCH-dynamic VaR, Kupiec backtest, stress scenarios.
This becomes GitHub project #3 — your flagship.
